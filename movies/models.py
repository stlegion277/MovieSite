...
class Directors(models.Model):
    name = models.CharField("Режиссер", max_length=160)
    description = models.TextField("Описание")
...
class Movies(models.Model):
    ...
    worldPremiere = models.DateField("Премьера в мире", default=date.today)
    budget = models.PositiveBigIntegerField("Бюджет", default=0, help_text="указывать сумму в долларах")
    feesInUSA = models.PositiveBigIntegerField("Сборы в США", default=0, help_text="указывать сумму в долларах")
    feesInWorld = models.PositiveBigIntegerField("Сборы в мире", default=0, help_text="указывать сумму в долларах")
    ...
    def get_absolute_url(self):
        return reverse("movies_detail.html", kwargs={"slug": self.url})
